...
def main(study_id):
  ...
  for single_gene in df_tcr["GeneID"].values:
    ...
    single_gene_symbol = str(df_tcr[df_tcr['GeneID']==single_gene]["Symbol"].iloc[0])
    background_genes = []
    ner_length = int(df_tcr[df_tcr["GeneID"] == single_gene]["protein_length"].iloc[0])
    ...
    if len(all_background_genes[single_gene]) == 0:  
      with open("./tcr/" + study_id + "/no_random_lists_tcr_" + study_id + ".txt", "a+") as f_no_random:
        f_no_random.write(single_gene_symbol + "\n") 
    else:
      # save all_background_genes
      with open("./tcr/" + study_id + "/all_background_genes_tcr_" + study_id + ".txt", "a+") as f_all_back:
      ...
      with open("./tcr/" + study_id + "/random_backgrounds_tcr_" + study_id + ".txt", "a+") as f_random:
      ...
      cancer_type_summary_tcr = {} # {randomlist: genedict} where genedict is dict of mutated sample ids for the gene in randomlist
      ...
      df.to_csv("./tcr/" + study_id + "/cancer_type_summary_tcr_"+ single_gene_symbol + "_" + study_id + ".txt", sep="\t")
      ...
      df.to_csv("./tcr/" + study_id + "/ner_gene_dict_tcr_" + single_gene_symbol + "_" + study_id + ".txt", sep="\t")
      ...
      df.to_csv("./tcr/" + study_id + "/cancer_type_summary_sample_percentage_tcr_" + single_gene_symbol + "_" + study_id + ".txt", sep="\t")
      ...
      df.to_csv("./tcr/" + study_id + "/ner_sample_percentages_tcr_" + single_gene_symbol + "_" + study_id + ".txt", sep="\t")
