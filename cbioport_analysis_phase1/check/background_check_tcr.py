...
def main(study_id, knee_index):
  ...
  for gene in df_tcr["GeneID"]:        # iterate genes in each study
  ...
  df.to_csv(study_id + "/all_background_genes_tcr_" + study_id + ".txt", sep="\t")
  ...
  df.to_csv(study_id + "/random_backgrounds_tcr_1000_" + study_id + ".txt", sep="\t")

  # obtain mutated samples for background genes
  cancer_type_summary_tcr = {} # {gene: [] for gene in df_tcr["Gene"]} for study_id
  df = pd.DataFrame(mutations_in_study)
  ...
  df.to_csv(study_id + "/cancer_type_summary_tcr_1000_" + study_id + ".txt", sep="\t")
  ...
  df.to_csv(study_id + "/ner_gene_dict_tcr_" + study_id + ".txt", sep="\t")
  ...
  df.to_csv(study_id + "/cancer_type_summary_sample_percentage_tcr_1000_" + study_id + ".txt", sep="\t")
  ...
  df.to_csv(study_id + "/ner_sample_percentages_tcr_" + study_id + ".txt", sep="\t")
