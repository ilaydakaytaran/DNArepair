...
def main(study_id):
  ...
  for single_gene in df_common["GeneID"].values:
    ...
    single_gene_symbol = str(df_common[df_common['GeneID']==single_gene]["Symbol"].iloc[0])
    background_genes = []
    ner_length = int(df_common[df_common["GeneID"] == single_gene]["protein_length"].iloc[0])
    ...
    if len(all_background_genes[single_gene]) == 0:  
      with open("./common/" + study_id + "/no_random_lists_common_" + study_id + ".txt", "a+") as f_no_random:
        f_no_random.write(single_gene_symbol + "\n") 
    else:
      # save all_background_genes
      with open("./common/" + study_id + "/all_background_genes_common_" + study_id + ".txt", "a+") as f_all_back:
      ...
      with open("./common/" + study_id + "/random_backgrounds_common_" + study_id + ".txt", "a+") as f_random:
      ...
      cancer_type_summary_common = {} # {randomlist: genedict} where genedict is dict of mutated sample ids for the gene in randomlist
      ...
      df.to_csv("./common/" + study_id + "/cancer_type_summary_common_"+ single_gene_symbol + "_" + study_id + ".txt", sep="\t")
      ...
      df.to_csv("./common/" + study_id + "/ner_gene_dict_common_" + single_gene_symbol + "_" + study_id + ".txt", sep="\t")
      ...
      df.to_csv("./common/" + study_id + "/cancer_type_summary_sample_percentage_common_" + single_gene_symbol + "_" + study_id + ".txt", sep="\t")
      ...
      df.to_csv("./common/" + study_id + "/ner_sample_percentages_common_" + single_gene_symbol + "_" + study_id + ".txt", sep="\t")
