...
def main(study_id):
  ...
  df.to_csv("./cancer_studies_background/" + study_id + "/all_background_genes_gg_" + study_id + ".txt", sep="\t")
  ...
  df.to_csv("./cancer_studies_background/" + study_id + "/random_backgrounds_gg_1000_" + study_id + ".txt", sep="\t") 

 
  # obtain mutated samples for background genes
  cancer_type_summary_gg = {} # {randomlist: genedict} where genedict is dict of mutated sample ids for each gene in randomlist
  ...
  df.to_csv("./cancer_studies_background/" + study_id + "/cancer_type_summary_gg_1000_" + study_id + ".txt", sep="\t")
  ...
  df.to_csv("./cancer_studies_background/" + study_id + "/ner_gene_dict_gg_" + study_id + ".txt", sep="\t")
  ...
  df.to_csv("./cancer_studies_background/" + study_id + "/cancer_type_summary_sample_percentage_gg_1000_" + study_id + ".txt", sep="\t")
  ...
  df.to_csv("./cancer_studies_background/" + study_id + "/ner_sample_percentages_gg_" + study_id + ".txt", sep="\t")
