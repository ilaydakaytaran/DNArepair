...
def main(study_id):
  ...
  df.to_csv("./cancer_studies/" + study_id + "/all_background_genes_tcr_" + study_id + ".txt", sep="\t")
  ...
  df.to_csv("./cancer_studies/" + study_id + "/random_backgrounds_tcr_1000_" + study_id + ".txt", sep="\t") 
  ...
  df.to_csv("./cancer_studies/" + study_id + "/cancer_type_summary_tcr_1000_" + study_id + ".txt", sep="\t")
  ...
  df.to_csv("./cancer_studies/" + study_id + "/ner_gene_dict_tcr_" + study_id + ".txt", sep="\t")
  ...
  df.to_csv("./cancer_studies/" + study_id + "/cancer_type_summary_sample_percentage_tcr_1000_" + study_id + ".txt", sep="\t")
  ...
  df.to_csv("./cancer_studies/" + study_id + "/ner_sample_percentages_tcr_" + study_id + ".txt", sep="\t")
