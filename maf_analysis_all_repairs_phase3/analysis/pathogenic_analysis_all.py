...
def main(study_id):
  ...
  df.to_csv("./cancer_studies/" + study_id + "/repair_gene_dict_all_" + study_id + ".txt", sep="\t")
  ...
  df.to_csv("./cancer_studies/" + study_id + "/repair_sample_percentages_all_" + study_id + ".txt", sep="\t")
