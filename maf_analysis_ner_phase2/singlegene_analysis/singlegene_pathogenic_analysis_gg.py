...
def main(study_id):
  ...
  for single_gene in df_gg["GeneID"].values:
    ...
    single_gene_symbol = str(df_gg[df_gg['GeneID']==single_gene]["Symbol"].iloc[0])
    background_genes = []
    ner_length = int(df_gg[df_gg["GeneID"] == single_gene]["protein_length"].iloc[0])
    ...
    if len(all_background_genes[single_gene]) == 0:  
      with open("./gg/" + study_id + "/no_random_lists_gg_" + study_id + ".txt", "a+") as f_no_random:
        f_no_random.write(single_gene_symbol + "\n") 
    else:
      # save all_background_genes
      with open("./gg/" + study_id + "/all_background_genes_gg_" + study_id + ".txt", "a+") as f_all_back:
      ...
      with open("./gg/" + study_id + "/random_backgrounds_gg_" + study_id + ".txt", "a+") as f_random:
      ...
      cancer_type_summary_gg = {} # {randomlist: genedict} where genedict is dict of mutated sample ids for the gene in randomlist
      ...
      df.to_csv("./gg/" + study_id + "/cancer_type_summary_gg_"+ single_gene_symbol + "_" + study_id + ".txt", sep="\t")
      ...
      df.to_csv("./gg/" + study_id + "/ner_gene_dict_gg_" + single_gene_symbol + "_" + study_id + ".txt", sep="\t")
      ...
      df.to_csv("./gg/" + study_id + "/cancer_type_summary_sample_percentage_gg_" + single_gene_symbol + "_" + study_id + ".txt", sep="\t")
      ...
      df.to_csv("./gg/" + study_id + "/ner_sample_percentages_gg_" + single_gene_symbol + "_" + study_id + ".txt", sep="\t")
